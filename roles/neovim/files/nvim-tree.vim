...
" lua-tree starting behavior (no arguments)
autocmd StdinReadPre * let s:std_in=1
autocmd VimEnter * if argc() == 0 && !exists("s:std_in") | Startify | wincmd w | endif

" lua-tree starting behavior (argument is a directory)
autocmd StdinReadPre * let s:std_in=1
autocmd VimEnter * if argc() == 1 && isdirectory(argv()[0]) && !exists("s:std_in") | exe 'LuaTreeOpen' argv()[0] | wincmd p | ene | exe 'cd '.argv()[0] | endif
